...
const HomeView = ({ 
  ...
  useEffect(() => {
    ...
    if (!existingScript) {
      ...
      document.body.appendChild(script);
        ...
        // Force reload of widgets if script exists
        setTimeout(() => {
            // @ts-ignore
  ...
  return (
    <div className="space-y-8 animate-fade-in relative">
      ...
      {/* Twitter Feed */}
      <div className="bg-arc-800 rounded-lg border border-arc-700 shadow-xl overflow-hidden flex flex-col">
          ...
          <div className="mt-8 mx-4 space-y-2">
            <div className="p-3 bg-arc-800 rounded border border-arc-700 flex items-center space-x-3">
              ...
              <div className="overflow-hidden flex-grow">
                ...
                <div className="text-sm text-white font-mono truncate">{user?.username || currentUser}</div>
