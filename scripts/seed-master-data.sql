-- ARC Raiders Companion - Master Data Seed Script
-- This script contains INSERT statements for all master data.
-- It is safe to run on an existing database with the correct schema.
