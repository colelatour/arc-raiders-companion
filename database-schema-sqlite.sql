...
CREATE UNIQUE INDEX raider_profiles_user_id_raider_name_key ON raider_profiles  (user_id, raider_name);
...
INSERT INTO users (id, email, username, password_hash, role, created_at, updated_at, is_active, email_verified) VALUES (1, 'admin@arcraiders.com', 'admin', '$2b$10$z01AERBMPtKFZfFlny5AJelUd2WJ/5fLSy0Mz6hYp3wcyz9Lhr502', 'admin', datetime('now'), CURRENT_TIMESTAMP, 1, 1);

-- Create default raider profile for admin user
INSERT INTO raider_profiles (id, user_id, raider_name, expedition_level, created_at, updated_at, is_active) VALUES (1, 1, 'admin', 0, datetime('now'), CURRENT_TIMESTAMP, 1);
...
CREATE UNIQUE INDEX blueprints_name_key ON blueprints  (name);
CREATE INDEX idx_blueprints_workshop ON blueprints  (workshop);

-- Data for blueprints
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (1, 'Anvil', 'Gunsmith 2', '5x Mech Comp, 5x Simple Gun Parts', 1, 0, FALSE, 1, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (2, 'Anvil Splitter', 'Gunsmith 3', NULL, 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (3, 'Angled Grip II', 'Gunsmith 2', '2x Mech Comp, 3x Duct Tape', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (4, 'Barricade Kit', 'Utility Station 2', '1x Mech Comp', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (5, 'Bettina', 'Gunsmith 3', '3x Adv Mech Comp, 3x Heavy Gun Parts, 3x Canister', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (6, 'Blaze Grenade', 'Explosives Station 3', '1x Expl Compound, 2x Oil', 1, 0, FALSE, 1, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (7, 'Bobcat', 'Gunsmith 3', NULL, 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (8, 'Burletta', 'Gunsmith 1', '3x Mech Comp, 3x Simple Gun Parts', 0, FALSE, 1, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (9, 'Combat Mk. 3 (AGGRESSIVE)', 'Gear Bench 3', '2x Adv Elec Comp, 3x Processor', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (10, 'Compensator II', 'Gunsmith 2', '2x Mech Comp, 4x Wires', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (11, 'Complex Gun Parts', 'Refiner 3', '1x Light/Medium/Heavy Gun Parts', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (12, 'Defibrillator', 'Medical Lab 2', '9x Plastic Parts, 1x Moss', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (13, 'Explosive Mine', 'Explosives Station 3', '1x Expl Compound, 1x Sensors', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (14, 'Extended Light Magazine II', 'Gunsmith 2', '2x Mech Comp, 3x Steel Spring', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (15, 'Equalizer', 'Gunsmith 3', '3x Mag Accel, 3x Complex GP, 1x Queen Reactor', 0, 1, 0, FALSE, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (16, 'Heavy Gun Parts', 'Refiner 2', '4x Simple Gun Parts', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (17, 'Horizontal Grip', 'Gunsmith 3', '2x Mod Comp, 5x Duct Tape', 1, 0, FALSE, 1, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (18, 'Hullcracker', 'Gunsmith 3', '1x Mag Accel, 3x Heavy GP, 1x Exodus Mod', 0, FALSE, 1, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (19, 'Il Toro', 'Gunsmith 1', '5x Mech Comp, 6x Simple GP', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (20, 'Jolt Mine', 'Explosives Station 2', '1x Elec Comp, 1x Battery', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (21, 'Jupiter', 'Gunsmith 3', '3x Mag Accel, 3x Complex GP, 1x Queen Reactor', 0, 1, 0, FALSE, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (22, 'Launcher Ammo', 'Workbench 1', '5x Metal Parts, 1x Crude Explosives', 0, FALSE, 1, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (23, 'Light Gun Parts', 'Refiner 2', '4x Simple Gun Parts', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (24, 'Light Stick (Any)', 'Utility Station 1', '3x Chemicals', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (25, 'Looting Mk. 3 (SURVIVOR)', 'Gear Bench 3', '2x Adv Elec Comp, 3x Processor', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (26, 'Lure Grenade', 'Utility Station 2', '1x Speaker Comp, 1x Elec Comp', 0, FALSE, 1, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (27, 'Muzzle Brake II', 'Gunsmith 2', '2x Mech Comp, 4x Wires', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (28, 'Osprey', 'Gunsmith 3', '2x Adv Mech Comp, 3x Medium GP, 7x Wires', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (29, 'Padded Stock', 'Gunsmith 3', '2x Mod Comp, 5x Duct Tape', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (30, 'Remote Raider Flare', 'Utility Station 1', '2x Chemicals, 4x Rubber Parts', 1, 0, FALSE, 1, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (31, 'Shotgun Choke II', 'Gunsmith 2', '2x Mech Comp, 4x Wires', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (32, 'Smoke Grenade', 'Utility Station 2', '14x Chemicals, 1x Canister', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (33, 'Stable Stock II', 'Gunsmith 2', '2x Mech Comp, 3x Duct Tape', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (34, 'Tactical Mk. 3 (DEFENSE/HEAL)', 'Gear Bench 3', '2x Adv Elec Comp, 3x Processor', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (35, 'Tagging Grenade', 'Utility Station 3', '1x Elec Comp, 1x Sensors', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (36, 'Torrente', 'Gunsmith 3', '2x Adv Mech Comp, 3x Medium GP, 6x Steel Spring', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (37, 'Trigger ''Nade', 'Explosives Station 2', '2x Crude Explosives, 1x Processor', 1, 0, 1, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (38, 'Venator', 'Gunsmith 2', '2x Adv Mech Comp, 3x Medium GP, 5x Magnet', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (39, 'Vertical Grip II', 'Gunsmith 2', '2x Mech Comp, 3x Duct Tape', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (40, 'Vita Shot', 'Medical Lab 3', '2x Antiseptic, 1x Syringe', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (41, 'Vita Spray', 'Medical Lab 3', '3x Antiseptic, 1x Canister', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (42, 'Vulcano', 'Gunsmith 3', '1x Mag Accel, 3x Heavy GP, 1x Exodus Mod', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
INSERT INTO blueprints (id, name, workshop, recipe, is_lootable, is_harvester_event, is_quest_reward, is_trails_reward, created_at) VALUES (43, 'Wolfpack', 'Explosives Station 3', '2x Expl Compound, 2x Sensors', 1, 0, FALSE, 0, '2025-12-09T20:33:25.654Z');
...
CREATE UNIQUE INDEX safe_items_item_name_key ON safe_items  (item_name);
...
CREATE UNIQUE INDEX workbenches_name_key ON workbenches  (name);
...
CREATE UNIQUE INDEX expedition_parts_name_key ON expedition_parts  (name);
...
CREATE INDEX quest_objectives_quest_id_order_index_key ON quest_objectives  (quest_id, order_index);
...
CREATE UNIQUE INDEX raider_completed_quests_raider_profile_id_quest_id_key ON raider_completed_quests  (raider_profile_id, quest_id);
...
CREATE UNIQUE INDEX raider_owned_blueprints_raider_profile_id_blueprint_id_key ON raider_owned_blueprints  (raider_profile_id, blueprint_id);
...
CREATE UNIQUE INDEX raider_completed_workbenches_raider_profile_id_workbench_id_key ON raider_completed_workbenches  (raider_profile_id, workbench_id);
...
CREATE UNIQUE INDEX raider_completed_expedition_p_raider_profile_id_expedition__key ON raider_completed_expedition_parts  (raider_profile_id, expedition_part_id);
...
CREATE UNIQUE INDEX favorite_raiders_user_id_raider_profile_id_key ON favorite_raiders  (user_id, raider_profile_id);
